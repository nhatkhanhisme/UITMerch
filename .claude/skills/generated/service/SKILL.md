---
name: service
description: "Skill for the Service area of UITMerch. 438 symbols across 104 files."
---

# Service

438 symbols | 104 files | Cohesion: 69%
...
| `backend/src/main/java/com/uitmerch/backend/merch/service/MerchService.java` | createMerch, getOwnMerchItem, updateMerch, deleteMerch, saveImages (+12) |
...
| `backend/src/main/java/com/uitmerch/backend/merch/repository/MerchItemRepository.java` | findByIdAndOrgId, restoreStock, findAllByStatus, countByOrgIdsAndStatus, existsByIdAndOrgId (+5) |
...
| `VisualSearch → Remove` | cross_community | 7 |
