...
This project is indexed by GitNexus as **UITMerch** (3848 symbols, 9230 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
