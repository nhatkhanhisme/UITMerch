...
public class CustomerOrderController {
    ...
    @Operation(summary = "List customer orders", description = "Returns paginated orders. Filter by status using ?status=PENDING.")
    @ApiResponses({
    ...
    @ApiResponses({
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Validation failed or insufficient stock"),
    ...
    @Operation(
        ...
        description = "Customers may only cancel their own PENDING orders. A cancellation reason is mandatory."
    )
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Order cancelled"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Order not PENDING or missing reason"),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Order not found")
    })
    public ResponseEntity<ApiResponse<OrderResponse>> cancelOrder(
        ...
        OrderResponse order = orderService.cancelCustomerOrder(UUID.fromString(userId), id, request);
